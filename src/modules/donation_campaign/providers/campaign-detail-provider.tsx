...
const CampaignDetailContext = createContext<CampaignDetailContextValue | undefined>(undefined);
...
export const CampaignDetailProvider = ({ children, initialCampaign }: CampaignDetailProviderProps) => {
...
export const useCampaignDetailContext = () => {
  ...
  if (!context) throw new Error("useCampaignDetailContext must be used within CampaignDetailProvider");
  return context;
};
